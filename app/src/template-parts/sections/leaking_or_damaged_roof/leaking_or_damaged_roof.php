<div class="wrapper-section rmbt-leaking-or-damaged-roof-block-wrapper-section">
   <div class="rmbt-full-width rmbt-leaking-or-damaged-roof-block-full-width">
      ...
      <section class="rmbt-container rmbt-leaking-or-damaged-roof-block">
         ...
         <div class="rmbt-leaking-or-damaged-roof-block__cards-wrap">

            <svg class="rmbt-leaking-or-damaged-roof-block__svg-path">
               <use
                  xlink:href="<?php echo get_template_directory_uri() ?>/assets/img/icons/sprite.svg#leaking_or_damaged_roof_path">
               </use>
            </svg>
